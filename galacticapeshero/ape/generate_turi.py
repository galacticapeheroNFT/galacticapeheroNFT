...
for i in range(9999):
    ...
    if len(rfd['attributes']) == 1:
        ...
        f=open("./"+str(i+1),'w')
        f.write('{"name":"GalacticApe Hero #'+str(i+1)+'","image":"https://raw.githubusercontent.com/galacticapeheroNFT/galacticapeheroNFT/main/galacticapeshero/ape/'+str(i+1)+'.png","attributes":['+trait_type0+']}')

    elif len(rfd['attributes']) == 2:
        trait_type0 = str(rfd['attributes'][0])
        trait_type1 = str(rfd['attributes'][1])
        f=open("./tokenuri/"+str(i+1),'w')
        f.write('{"name":"GalacticApe Hero #'+str(i+1)+'","image":"https://raw.githubusercontent.com/galacticapeheroNFT/galacticapeheroNFT/main/galacticapeshero/ape/'+str(i+1)+'.png","attributes":['+trait_type0+','+trait_type1+']}')
        ...
        f=open("./"+str(i+1),'w')
        f.write('{"name":"GalacticApe Hero #'+str(i+1)+'","image":"https://raw.githubusercontent.com/galacticapeheroNFT/galacticapeheroNFT/main/galacticapeshero/ape/'+str(i+1)+'.png","attributes":['+trait_type0+','+trait_type1+','+trait_type2+']}')
        ...
        f=open("./"+str(i+1),'w')
        f.write('{"name":"GalacticApe Hero #'+str(i+1)+'","image":"https://raw.githubusercontent.com/galacticapeheroNFT/galacticapeheroNFT/main/galacticapeshero/ape/'+str(i+1)+'.png","attributes":['+trait_type0+','+trait_type1+','+trait_type2+','+trait_type3+']}')
        ...
        f=open("./"+str(i+1),'w')
        f.write('{"name":"GalacticApe Hero #'+str(i+1)+'","image":"https://raw.githubusercontent.com/galacticapeheroNFT/galacticapeheroNFT/main/galacticapeshero/ape/'+str(i+1)+'.png","attributes":['+trait_type0+','+trait_type1+','+trait_type2+','+trait_type3+','+trait_type4+']}')
        ...
        f=open("./"+str(i+1),'w')
        f.write('{"name":"GalacticApe Hero #'+str(i+1)+'","image":"https://raw.githubusercontent.com/galacticapeheroNFT/galacticapeheroNFT/main/galacticapeshero/ape/'+str(i+1)+'.png","attributes":['+trait_type0+','+trait_type1+','+trait_type2+','+trait_type3+','+trait_type4+','+trait_type5+']}')
        ...
        f=open("./"+str(i+1),'w')
        f.write('{"name":"GalacticApe Hero #'+str(i+1)+'","image":"https://raw.githubusercontent.com/galacticapeheroNFT/galacticapeheroNFT/main/galacticapeshero/ape/'+str(i+1)+'.png","attributes":['+trait_type0+','+trait_type1+','+trait_type2+','+trait_type3+','+trait_type4+','+trait_type5+','+trait_type6+']}')
